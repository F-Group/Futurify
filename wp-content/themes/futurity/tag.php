            ...
            <div class="col-md-12">
                <div class="bl-blog-list-content ">
                    <div class="row list-blog">
                        ...
                        <?php echo do_shortcode("[ajax_load_more post_type='post' posts_per_page='6' max_pages='3' container_type='div' css_classes='col-xs-12 col-sm-12 col-md-12' button_loading_label='' tag='{$tag}']") ?>
                    </div>
                </div>
            </div>
        </div>
